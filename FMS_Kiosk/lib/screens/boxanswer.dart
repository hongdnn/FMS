...
class BoxAnswer extends StatefulWidget {
  final MyFeedback myFeedback;
  final int currentQuestion;
  final List<MyResponse> listResponse;

  BoxAnswer(this.myFeedback, this.currentQuestion, this.listResponse);
  @override
  State<StatefulWidget> createState() => BoxAnswerState();
}

class BoxAnswerState extends State<BoxAnswer> {
  String choice = "-1";
                                ...
                                switch (index) {
                                  case 0:
                                    return Container(
                                      decoration: BoxDecoration(
                                        border: Border.all(
                                          color: Color.fromRGBO(164, 41, 26,1.0), width: 1.0),
                                      ...
                                      child: Center(child: Text(
                                        ...
                                        style: TextStyle(
                                            fontSize: MediaQuery.of(context).size.width *0.0032,
                                            fontWeight: FontWeight.bold,
                                            color:  Color.fromRGBO(164, 41, 26,1.0)
                                            ),
                                      ),)
                                    );
                                  case 1:
                                    return Container(
                                      decoration: BoxDecoration(
                                        border: Border.all(
                                          color: Color.fromRGBO(195, 55, 38,1.0), width: 1.0),
                                          borderRadius: BorderRadius.all(Radius.circular(1.0)
                                  )
                                      ),
                                      height:
                                      ...
                                      child: Center(child: Text(
                                        ...
                                        style: TextStyle(
                                            fontSize: MediaQuery.of(context).size.width *0.0032,
                                            fontWeight: FontWeight.bold,
                                            color:  Color.fromRGBO(195, 55, 38,1.0)
                                            ),
                                      ),)
                                    );
                                  case 2:
                                    return Container(
                                      decoration: BoxDecoration(
                                        border: Border.all(
                                          color: Color.fromRGBO(232, 76, 54,1.0), width: 1.0),
                                          borderRadius: BorderRadius.all(Radius.circular(1.0)
                                  )
                                      ),
                                      height:
                                      ...
                                      child: Center(child: Text(
                                        ...
                                        style: TextStyle(
                                            fontSize: MediaQuery.of(context).size.width *0.0032,
                                            fontWeight: FontWeight.bold,
                                            color:  Color.fromRGBO(232, 76, 54,1.0)
                                            ),
                                      ),)
                                    );
                                  case 3:
                                    return Container(
                                      decoration: BoxDecoration(
                                        border: Border.all(
                                          color: Color.fromRGBO(246, 155, 1,1.0), width: 1.0),
                                          borderRadius: BorderRadius.all(Radius.circular(1.0)
                                  )
                                      ),
                                      height:
                                      ...
                                      child: Center(child: Text(
                                        ...
                                        style: TextStyle(
                                            fontSize: MediaQuery.of(context).size.width *0.0032,
                                            fontWeight: FontWeight.bold,
                                            color:  Color.fromRGBO(246, 155, 2,1.0)
                                            ),
                                      ),)
                                    );
                                  case 4:
                                    return Container(
                                      decoration: BoxDecoration(
                                        border: Border.all(
                                          color: Color.fromRGBO(245, 180, 0,1.0), width: 1.0),
                                          borderRadius: BorderRadius.all(Radius.circular(1.0)
                                  )
                                      ),
                                      height:
                                      ...
                                      child: Center(child: Text(
                                        ...
                                        style: TextStyle(
                                            fontSize: MediaQuery.of(context).size.width *0.0032,
                                            fontWeight: FontWeight.bold,
                                            color:  Color.fromRGBO(245, 180, 0,1.0)
                                            ),
                                      ),)
                                    );
                                  case 5:
                                    return Container(
                                      decoration: BoxDecoration(
                                        border: Border.all(
                                          color: Color.fromRGBO(249, 203, 65,1.0), width: 1.0),
                                          borderRadius: BorderRadius.all(Radius.circular(1.0)
                                  )
                                      ),
                                      height:
                                      ...
                                      child: Center(child: Text(
                                        ...
                                        style: TextStyle(
                                            fontSize: MediaQuery.of(context).size.width *0.0032,
                                            fontWeight: FontWeight.bold,
                                            color:  Color.fromRGBO(249, 203, 65,1.0)
                                            ),
                                      ),)
                                    );
                                  case 6:
                                    return Container(
                                      decoration: BoxDecoration(
                                        border: Border.all(
                                          color: Color.fromRGBO(254, 216, 115,1.0), width: 1.0),
                                          borderRadius: BorderRadius.all(Radius.circular(1.0)
                                  )
                                      ),
                                      height:
                                      ...
                                      child: Center(child: Text(
                                        ...
                                        style: TextStyle(
                                            fontSize: MediaQuery.of(context).size.width *0.0032,
                                            fontWeight: FontWeight.bold,
                                            color:  Color.fromRGBO(254, 216, 115,1.0)
                                            ),
                                      ),)
                                    );
                                  case 7:
                                    return Container(
                                      decoration: BoxDecoration(
                                        border: Border.all(
                                          color: Color.fromRGBO(255, 225, 103,1.0), width: 1.0),
                                          borderRadius: BorderRadius.all(Radius.circular(1.0)
                                  )
                                      ),
                                      height:
                                      ...
                                      child: Center(child: Text(
                                        ...
                                        style: TextStyle(
                                            fontSize: MediaQuery.of(context).size.width *0.0032,
                                            fontWeight: FontWeight.bold,
                                            color:  Color.fromRGBO(255, 225, 103,1.0)
                                            ),
                                      ),)
                                    );
                                  case 8:
                                    return Container(
                                      decoration: BoxDecoration(
                                        border: Border.all(
                                          color: Color.fromRGBO(255, 223, 107,1.0), width: 1.0),
                                          borderRadius: BorderRadius.all(Radius.circular(1.0)
                                  )
                                      ),
                                      height:
                                      ...
                                      child: Center(child: Text(
                                        ...
                                        style: TextStyle(
                                            fontSize: MediaQuery.of(context).size.width *0.0032,
                                            fontWeight: FontWeight.bold,
                                            color:  Color.fromRGBO(255, 223, 107,1.0)
                                            ),
                                      ),)
                                    );
                                  case 9:
                                    return Container(
                                      decoration: BoxDecoration(
                                        border: Border.all(
                                          color: Color.fromRGBO(27, 206, 108,1.0), width: 1.0),
                                          borderRadius: BorderRadius.all(Radius.circular(1.0)
                                  )
                                      ),
                                      height:
                                      ...
                                      child: Center(child: Text(
                                        ...
                                        style: TextStyle(
                                            fontSize: MediaQuery.of(context).size.width *0.0032,
                                            fontWeight: FontWeight.bold,
                                            color:  Color.fromRGBO(27, 206, 108,1.0)
                                            ),
                                      ),)
                                    );
                                    case 10:
                                    return Container(
                                      ...
                                      decoration: BoxDecoration(
                                        border: Border.all(
                                          color: Color.fromRGBO(29, 174, 94,1.0), width: 1.0),
                                          borderRadius: BorderRadius.all(Radius.circular(1.0)
                                  )
                                      ),
                                      height:
                                      ...
                                      child: Center(child: Text(
                                        ...
                                        style: TextStyle(
                                            fontSize: MediaQuery.of(context).size.width *0.0032,
                                            fontWeight: FontWeight.bold,
                                            color:  Color.fromRGBO(29, 174, 94,1.0)
                                            ),
                                      ),
                                      )
                                    );
