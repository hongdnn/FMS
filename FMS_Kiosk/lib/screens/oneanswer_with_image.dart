...
class OneAnswerWithImage extends StatefulWidget {
  final MyFeedback myFeedback;
  final int currentQuestion;
  final List<MyResponse> listResponse;

  OneAnswerWithImage(this.myFeedback, this.currentQuestion, this.listResponse);
  @override
  State<StatefulWidget> createState() => OneAnswerWithImageState();
}

class OneAnswerWithImageState extends State<OneAnswerWithImage> {
  String radioValue;
  String choice = "";
                                ...
                                children: <Widget>[
                                  Transform.scale(
                                    ...
                                    child: Radio(
                                      ...
                                      onChanged: onPressRadio,
                                    ),
                                  ),
                                  Text("  "),
                                  InkWell(
                                    onTap: (){
                                      onPressRadio(txt.data);
                                    },
                                    child: Text(
                                      txt.data,
                                      style: TextStyle(
  ...
  void onPressRadio(String value) {
    setState(() {
      radioValue = value;
      choice = value;
    });
