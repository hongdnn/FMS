...
class RatingAnswer extends StatefulWidget {
  ...
  RatingAnswer(this.myFeedback, this.currentQuestion, this.listResponse);
  @override
  State<StatefulWidget> createState() => RatingAnswerState();
}

class RatingAnswerState extends State<RatingAnswer> {
  String choice = "0";
