...
class OneAnswer extends StatefulWidget {
  ...
  OneAnswer(this.myFeedback, this.currentQuestion, this.listResponse);
  @override
  State<StatefulWidget> createState() => OneAnswerState();
}

class OneAnswerState extends State<OneAnswer> {
  String radioValue;
  String choice = "";
