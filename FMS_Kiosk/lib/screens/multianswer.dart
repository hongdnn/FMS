...
class MultiAnswer extends StatefulWidget {
  ...
  MultiAnswer(this.myFeedback, this.currentQuestion, this.listResponse);
  @override
  State<StatefulWidget> createState() => MultiAnswerState();
}

class MultiAnswerState extends State<MultiAnswer> {
