...
import 'package:my_demo/screens/multianswer_with_image.dart';
...
class EmotionAnswerWithImage extends StatefulWidget {
  final MyFeedback myFeedback;
  final int currentQuestion;
  final List<MyResponse> listResponse;

  EmotionAnswerWithImage(
      this.myFeedback, this.currentQuestion, this.listResponse);
  @override
  State<StatefulWidget> createState() => EmotionAnswerWithImageState();
}

class EmotionAnswerWithImageState extends State<EmotionAnswerWithImage> {
  String choice = "0";
                                ...
                                Padding(
                                  ...
                                  child: Column(children: <Widget>[
                                    InkWell(
                                      ...
                                      child: Ink.image(
                                        image:
                                            AssetImage('assets/confused.png'),
                                        width:
                                            MediaQuery.of(context).size.width *
                                                0.08,
                                        height:
